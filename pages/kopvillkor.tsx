        ...
        <ContainerWithBorder>
          <Flex direction="column" style={{ width: "100%" }}>
            ...
            <Br>
              ...
              krävs enligt Föräldrabalken målsmans medgivande. Genom beställning
              på makeupbys.se godkänner du de vid tiden publicerade villkor som
              anges nedan och intygar att de uppgifter du lämnar om dig själv är
              korrekta.
            </Br>
            <Text size={14} mt={5}>
              Med benämningarna vi, våra, vårt och oss nedan avses MakeUpByS AB.
            </Text>
            ...
            <Br>
              ...
              av produkten. Vi accepterar inget ansvar för förseningar/fel till
              följd av omständigheter utanför företagets rådande (Force
              Majeure). Dessa omständigheter kan exempelvis vara arbetskonflikt,
              eldsvåda, krig, myndighetsbeslut, förminskad eller utebliven
              leverans från leverantör. Vidare tas inget ansvar för eventuella
              förändringar på produkter/produktegenskaper som ändrats av
            ...
            <Br>
              ...
              eller inte hämtats ut är det upp till dig att betala ny frakt. För
              beställningar som inte hämtas ut debiterar vi en avgift på 250
              SEK.
            </Br>
            <Ti>Kampanjer</Ti>
            <Br>
            ...
            <Br>
              ...
              att vi har meddelat dig om längre leveranstid) ber vi dig kontakta
              vår kundtjänst.
            </Br>
            <Ti>Priser</Ti>
            <Br>
              ...
              för prisändringar beroende på felaktig information och förbehåller
              oss rätten att justera priset.
            </Br>
            ...
            <Ti>Skada</Ti>
            <Br>
              I fall av trasig eller öppnad kartong vid leverans, kontakta ditt
              utlämningsställe direkt när du hämtar ut paketet. De har färdiga
            ...
            <Br>
              ...
              med beställning eller besök på webbplatsen
            </Br>
            <Ti>Reklamation</Ti>
            <Br>
              Vi följer Konsumentverkets rekommendationer för e-handel.
              Kundtjänst måste alltid kontaktas via vårt kontaktformulär, e-post
              (info@makeupbys.se) inom skälig tid. För mer information se nedan.
              Reklamationen måste göras via vårt kontaktformulär. Reklamation av
              trasig produkt ska ske inom skälig tid efter det att felet har
              upptäckts, dock senast inom 1 år från köptillfället. Observera att
              den trasiga produkten samt emballaget måste sparas tills dess att
              ärendet är löst. Om varan ej finns i lager eller har utgått så
              kontaktar vi dig innan vidare hantering. Vi hanterar
              reklamationsärenden normalt sett inom 3-14 arbetsdagar. Vid
              godkänd reklamation av köp så återbetalar vi summan för din
              beställning inom 30 dagar.
            </Br>
            <Ti>Undantag från ångerrätt</Ti>
            <Br>
              Produkten måste vara obruten och oanvänd men enligt lag har du
              rätt att säkerställa dess egenskaper och funktioner. Vid nyttjande
              av ångerrätten har vi rätt att göra ett värdeminskningsavdrag i de
              fall då varan hanterats i större omfattning än nödvändigt.
              Värdeminskning bedöms från fall till fall. Öppnade och/eller
              använda makeup produkter återtas inte på grund utav hälso- och
              hygienskäl. Vid godkänd hävning av köp så återbetalar vi summan
              för din beställning inom 21 dagar.
            </Br>
            <Ti>Ångerrätt</Ti>
            <Br>
              Vid köp av makeup-produkter på makeupbys.se har du som kund 30
              dagars ångerrätt som gäller från det att du har tagit emot en vara
              som du har beställt. Du är ansvarig för att kontrollera att
              leveransen och produkterna är oskadda i samband med mottagande av
              paketet.
            </Br>
            <Br>
              ...
              Märk returen tydligt med MakeUpByS och ditt ordernummer och skicka
              paketet till:
            </Br>
            <Br>
              MakeUpByS AB
            ...
            <Br>
              Vill du ha ett standardformulär för utövande av ångerrätten finns
              det att ta del av på konsumentverkets hemsida,
              www.konsumentverket.se Returhanteringen tar ca 1-3 veckor. Tänk på
              att spara kvittot på din retur och skicka spårbart så att vi kan
              ersätta dig för returen även i de fall paketet försvinner under
              leveransen.
            </Br>
          </Flex>
        </ContainerWithBorder>
